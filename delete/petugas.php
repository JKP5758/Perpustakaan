...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <form action="proseshapuspetugas.php" method="post">
                ...
                <div class="input-group">
                    ...
                    <input type="text" value="<?php echo $row['nama_petugas']; ?>" readonly name="nama_petugas">
                </div>
                <div class="input-group">
                    <label for="">No Telfon</label>
                    <input type="number" value="<?php echo $row['no']; ?>" readonly name="no">
                </div>
                <div class="input-group">
                    <label for="">Passsword</label>
                    <input type="text" value="<?php echo $row['password']; ?>" readonly name="password">
                </div>
                <div class="input-group">
                    ...
                    if ($row['leveluser'] == 'admin') { ?>
                        <Select name="leveluser">
                            <option hidden value="petugas">Petugas</option>
                ...
                <div class="input-group">
                    <input value="HAPUS" type="submit"  name="submit">
